function pagination(a) {
  ...
  postnumber > 1 && (e += 2 == postnumber ? "page" == type ? '<span class="showpage"><a class="page-link" href="' + home_page + '">' + prevpage + "</a></span>" : '<li class="page-item"><a class="page-link" href="/search/label/' + lblname1 + "?&max-results=" + postperpage + '">' + prevpage + "</a></li>" : "page" == type ? '<li class="page-item"><a class="page-link" href="#" onclick="redirectpage(' + s + ');return false">' + prevpage + "</a></li>" : '<li class="page-item"><a class="page-link" href="#" onclick="redirectlabel(' + s + ');return false">' + prevpage + "</a></li>"), start > 1 && (e += "page" == type ? '<li class="page-item"><a href="' + home_page + '">1</a></li>' : '<li class="page-item"><a href="/search/label/' + lblname1 + "?&max-results=" + postperpage + '">1</a></li>'), start > 2 && (e += "");
    for (var r = start; r <= end; r++) e += postnumber == r ? '<li class="page-item active"><a class="page-link" href="#">' + r + "</a></li>" : 1 == r ? "page" == type ? '<li class="page-item"><a class="page-link" href="' + home_page + '">1</a></li>' : '<li class="page-item"><a class="page-link" href="/search/label/' + lblname1 + "?&max-results=" + postperpage + '">1</a></li>' : "page" == type ? '<li class="page-item"><a class="page-link" href="#" onclick="redirectpage(' + r + ');return false">' + r + "</a></li>" : '<li class="page-item"><a href="#" onclick="redirectlabel(' + r + ');return false">' + r + "</a></li>";
    end < maximum - 1 && (e += ""), end < maximum && (e += "page" == type ? '<li class="page-item"><a href="#" onclick="redirectpage(' + maximum + ');return false">' + maximum + "</a></li>" : '<li class="page-item"><a class="page-link" href="#" onclick="redirectlabel(' + maximum + ');return false">' + maximum + "</a></li>");
